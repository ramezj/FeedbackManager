...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0">
  ...
  <div class="flex md:order-2">
      <button onClick={redirectDashboard} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{isLoggedIn}</button>
...
<br></br><br></br>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 ">
       ...
       <button onClick={redirectUser} class="shadow-md px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Get Started</button>
