...
export default function Home() {
  ...
  return (
    ...
    <GlowAlert />
        <h1 class="mb-4 text-7xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-8xl dark:text-white">The <b className="bg-gradient-to-r from-green-400 to-blue-500 inline-block text-transparent bg-clip-text">Next</b> Generation Feedback Manager</h1>
       ...
       <motion.button whileHover={{scale: 1.1}} onClick={redirectUser} class="bg-gradient-to-r from-green-400 to-blue-500 duration-500 shadow-xl px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors transform rounded-lg">
        Get Started
       </motion.button>     
