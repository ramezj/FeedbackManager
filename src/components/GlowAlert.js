...
const GlowAlert = () => {
    return (
        ...
        <a href="#" class="shadow-lg shadow-blue-500/50 inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
            <span class="shadow-md shadow-purple-500/20 bg-gradient-to-r from-purple-600 to-blue-500 text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3 font-bold">Beta</span> <span class="text-sm font-medium">Feedbacker is currently in Private <b>Beta</b></span> 
